...
global {
	...
	init {
		...
		// top nodes
		create footway_node with: (location: {x_middle - 5,	y_top_border}, list_connected_index:[1], label:"8");
		create footway_node with: (location: {x_middle + 5,	y_top_border}, list_connected_index:[2], label:"9");
