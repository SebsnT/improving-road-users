...
global {
	...
	init {
		...
		create footway_node with: (location: {x_middle + 5,		y_above_middle}, list_connected_index:[0,2,4]);
		...
		create footway_node with: (location: {x_middle + 5,		y_below_middle}, list_connected_index:[1,3,5]);
...
experiment signalized_one_street_3  type: gui {
