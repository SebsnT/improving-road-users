...
global {
	...
	reflex save_biycles_batch when: bicycles_batch {
		save [cycle, car_avg_speed, traffic_density_per_km, car_traffic_flow, num_cars_exiting] to: "../../output/simple_model/batch/" + bicycles_experiment_name + "_batch" + ".csv"
		format: "csv" rewrite: false;
	}
...
experiment only_cars_batch autorun: true type: batch repeat: 2 parallel: false until: cycle >= 1000 {
